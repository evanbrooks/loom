...
(function(){
  ...
  function Server() {
    ...
    window.staticRoot = '/Users/evan/Developer/degreeProject';
    ...
    io.sockets.on('connection', function (socket) {
      ...
      // Getting "cannot call method log of null" error here for some reason
      if (console) console.log("SOCKET CONNECTION EVENT!")
